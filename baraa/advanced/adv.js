...
class Vehicles {
    constructor(color, passengers, model, fuel, year, kilos, image) {
        this.color = color;
...
class bikes extends Vehicles {
    constructor(color, passengers, model, fuel, year, kilos, image, height, wheels) {
...
class trucks extends Vehicles {
    constructor(color, passengers, model, fuel, year, kilos, image, maxWeight, placesToDrive) {
        super(color, passengers, model, fuel, year, kilos, image);
...
let items = [car1, car2, car3, car4, car5, bike1, bike2, bike3, bike3, bike4, bike5, truck1, truck2, truck3, truck4, truck5];
