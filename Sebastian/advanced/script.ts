class Vehicle{
    ...
    constructor(brand: string, model: string, kilometers: number, seats: number, fuel: string, year: number ){
        this.brand = brand;
        this.model = model;
...
class Bikes extends Vehicle{
    wheels: number;
    constructor(brand: string, model: string, kilometers: number, seats: number, fuel: string, year: number, wheels: number){
...
class Trucks extends Bikes {
    ...
    constructor(brand: string, model: string, kilometers: number, seats: number, fuel: string, year: number, wheels: number, trailers: number){
...
let vehicles : Array<Vehicle>  = [car1, car2, car3, car4, bike1, truck1];


for(let val of vehicles){
    (document.getElementById("text")as HTMLElement).innerHTML += val.printVehicle();
}
